...
async def handle_start(bot:Client, message:Message):
    ...
    Btn = [
        ...
        [InlineKeyboardButton(text='🌻Uᴘᴅᴀᴛᴇs', url='https://t.me/ShopSphereAdsChannel'), InlineKeyboardButton(text='🌨️Aʙᴏᴜᴛ', callback_data='about')],
        [InlineKeyboardButton(text='❄️Dᴇᴠᴇʟᴏᴘᴇʀ', url='https://t.me/ShopSphereOwnerBot')]
        ]
...
@Client.on_message(filters.private & filters.command("restart") & filters.user(SUDO))
